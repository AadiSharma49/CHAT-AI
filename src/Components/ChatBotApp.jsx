    ...
    if(!activeChat){
      ...
      const response = await fetch("https://api.openai.com/v1/chat/completions",{
          ...
          headers: {
           ...
           Authorization:`Bearer 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`,},
          body:JSON.stringify({
           model:"gpt-3.5-turbo",
